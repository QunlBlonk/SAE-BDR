...
CREATE TABLE Enclos (
        ...
        spécificité VARCHAR(50) NOT NULL,
        id_zone INT NOT NULL,
...
CREATE TABLE Espece (
        ...
        est_menace NUMBER(1) NOT NULL CHECK (est_menace in (0,1)),
        id_zone INT,
...
CREATE TABLE Personnel (
        ...
        type_personnel_présent VARCHAR(50) NOT NULL,
        id_boutique INT,
